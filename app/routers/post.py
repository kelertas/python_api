...
# In post operation the newly created post should be returned back
# Also HTTP code 201 should be returned
...
# Always use plural in CRUD operations naming
# id - path parameter
...
# When delete request used no message should be returned except status code
@router.delete("/{id}", status_code=status.HTTP_204_NO_CONTENT)
def delete_post(id: int, db: 
